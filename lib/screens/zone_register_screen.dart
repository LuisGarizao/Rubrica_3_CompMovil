...
class ZoneRegister extends StatefulWidget {
  const ZoneRegister({super.key});

  @override
  State<ZoneRegister> createState() => _ZoneRegisterState();
}

class _ZoneRegisterState extends State<ZoneRegister> {
